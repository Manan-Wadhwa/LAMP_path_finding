...
def main():
    base_dir = r"C:\Users\Public\LAMP_DataStore\ElBagawat"
    buildings_path = os.path.join(base_dir, r"100_Data\130_BuildingFootprintsVectorData\BuildingTracesCurrent\Buildings_Mask.shp")
    doors_gt_path = os.path.join(base_dir, r"200_Projects\210_GSOC\code-manan\outputs\web_audit\doors_idea1.geojson")
    out_path = os.path.join(base_dir, r"200_Projects\210_GSOC\code-manan\outputs\web_audit\doors_idea12.geojson")
